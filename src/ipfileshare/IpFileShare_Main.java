...
public class IpFileShare_Main extends JFrame {

    public IpFileShare_Main() throws IOException, SocketException, URISyntaxException {
    ...
    public static void main(String[] args) throws IOException, SocketException, URISyntaxException {
        new IpFileShare_Main();
    }
