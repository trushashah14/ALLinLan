...
public class startChatServer extends javax.swing.JFrame {
    ...
    public void start(int PortNo, String ip) {
        this.ip=ip;
        this.PortNo=PortNo;
        lblip2.setText(ip);
        ...
        try {
            ...
            new Thread() {
                public void run() {
                    ...
                    try {
                        ...
                        taTextArea.setCharacterAttributes(attributeSet1, true);
                        try {
                            doc.insertString(doc1.getLength(), "Connected.Start Chatting\n\n", attributeSet);
                        } catch (BadLocationException ex1) {
                            ex1.printStackTrace();
                        }

                        send = new ConnectServer().Chat(connectedSocket, PortNo, taTextArea);
            ...
            //send = new ServerChat1(s,s1).startChat(PortNo, taTextArea);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("You are connected to IP Address :");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(lblport2, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 321, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(lblip2, javax.swing.GroupLayout.DEFAULT_SIZE, 286, Short.MAX_VALUE)))
                        .addGap(66, 66, 66))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(btSend1, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btFileActionPerformed
          try {
            //new IpFileShare_Send(ip,port).setVisible(true);
            new IpFileShare_Main1(ip,PortNo);//.setVisible(true);
        } catch (IOException ex) {
            Logger.getLogger(startChatServer.class.getName()).log(Level.SEVERE, null, ex);
